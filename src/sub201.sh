...
CLF_PARAMS="{'learning_rate': 0.03, 'learning_rates': [0.03] * 200 + [0.02] * 500, 'min_child_weight': 240, 'subsample': 0.9, 'colsample_bytree': 0.67, 'max_depth': 10, 'initial_params': [-0.01, 0.1, 0.1, 0.1, -0.1, -0.08, 0.02, -0.08, -0.01]}"
...
./SVR_offset_reg.py \
  ...
  --cv-grid="{'n_estimators': [700], 'gamma': [0.0, 1.0], 'max_depth': [8, 12], 'colsample_bytree': [0.6], 'subsample': [1.0], 'min_child_weight': [160, 240], 'int_fold': [4], 'learning_rate': [0.05]}" \
  -b 9 \
