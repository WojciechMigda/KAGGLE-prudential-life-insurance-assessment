...
#CLF_PARAMS="{'learning_rate': 0.05, 'learning_rates': [0.03] * 200 + [0.02] * 500, 'min_child_weight': 240, 'subsample': 0.9, 'colsample_bytree': 0.67, 'max_depth': 6, 'initial_params': [0.1, 0.1, 0.1, -0.1, -0.08, 0.02, -0.08, -0.01, -0.01]}" \
CLF_PARAMS="{'learning_rate': 0.05, 'learning_rates': [0.03] * 200 + [0.02] * 500, 'min_child_weight': 240, 'subsample': 0.9, 'colsample_bytree': 0.67, 'max_depth': 6, 'initial_params': [0.1, 0.1, 0.1, -0.1, -0.08, 0.02, -0.08, -0.01]}" \
