...
def work(in_h5,
    ...
    from nppipes import (as_array,fit_transform,transform,fit,predict,savetxt,
                         stack,clip
                         )
