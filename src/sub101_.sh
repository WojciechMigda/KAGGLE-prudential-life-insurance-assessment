...
CLF_PARAMS="{'int_fold': 7, 'learning_rate': 0.03, 'learning_rates': [0.03] * 200 + [0.02] * 500, 'min_child_weight': 160, 'subsample': 1.0, 'colsample_bytree': 0.6, 'max_depth': 8, 'initial_params': [-0.01, 0.1, 0.1, 0.1, -0.1, -0.08, 0.02, -0.08, -0.01]}"
